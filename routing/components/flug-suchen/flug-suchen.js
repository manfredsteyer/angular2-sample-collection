...
define(["require", "exports", 'angular2/angular2', 'angular2/angular2', 'services/flug-service', 'validation/city', 'angular2/router'], function (require, exports, angular2_1, angular2_2, flug_service_1, city_1, router_1) {
    var FlugSuchen = (function () {
        ...
        FlugSuchen = __decorate([
            ...
            angular2_1.View({
                ...
                directives: [angular2_1.NgFor, angular2_1.NgIf, angular2_2.FORM_DIRECTIVES, city_1.CityValidator, router_1.ROUTER_DIRECTIVES]
            }), 
